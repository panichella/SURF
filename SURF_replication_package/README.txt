1) "Experiment I" contains:
   a) "summaries" which contains all the html summaries generated through SURF 
      and browsed by study participants involved in the Experiment I.
   b) "XMLreviews" which contains, for each app involved in the Experiment I, 
...
2) "Experiment II" contains:
   a) "summaries" which contains the two html summaries generated through SURF 
      and browsed by study participants in the Experiment II.
   b) "XMLreviews" which contains, for each of the two app involved in the Experiment I, 
   ...
   d) "Experiment_II_survey_answers.xlsx" which contains all the answers to our
      survey collected from the Experiment II participants.
